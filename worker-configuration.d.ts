/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 9a457472b22c27e1896a6366e46d1e2b)
// Runtime types generated with workerd@1.20260329.1 2026-08-09 
declare namespace Cloudflare {
	interface Env {
		BUCKET: R2Bucket;
		IMAGES: ImagesBinding;
		REFERER_ALLOWLIST: ["example.com","*.example.com"];
		REFERER_POLICY_ALLOWLIST: "watermark:light";
		REFERER_POLICY_NO_REFERER: "watermark:light";
		REFERER_POLICY_OTHER: "watermark:strong";
		WATERMARK_SCHEMES_JSON: {"light":{"type":"text","text":"Protected","opacity":0.18,"bottom":24,"right":24,"fontSize":24,"color":"rgba(255,255,255,0.85)","width":320,"height":72},"strong":{"type":"text","text":"Protected","opacity":0.28,"bottom":20,"right":20,"fontSize":30,"color":"rgba(255,80,80,0.9)","width":360,"height":88}};
	}
}
