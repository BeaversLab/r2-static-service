/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 1d1faa0200ea038de27c4acd1a343d94)
// Runtime types generated with workerd@1.20260329.1 2026-04-01 
declare namespace Cloudflare {
	interface Env {
		BUCKET: R2Bucket;
		CURRENT_STORAGE: "r2";
		STORAGE_CONFIGS_JSON: {"r2":{"type":"r2","publicBaseUrl":"https://origin-r2.beaverslab.xyz","proxyBaseUrl":"https://your-r2-proxy.webp.se"},"qiniu":{"type":"qiniu","bucket":"static","publicBaseUrl":"https://cdn.example.com","proxyBaseUrl":"https://your-qiniu-proxy.webp.se","uploadUrl":"https://upload.qiniup.com"}};
		IMAGE_PROXY_WATERMARK_SCHEMES_JSON: {"light":{"text":"beaverslab.xyz","font":"bold 32px Arial","color":"FFFFFF","width":0.28,"offsetX":0.04,"offsetY":0.04},"strong":{"text":"beaverslab.xyz","font":"bold 44px Arial","color":"FF5050","width":0.36,"offsetX":0.04,"offsetY":0.04}};
		REFERER_ALLOWLIST: ["beaverslab.xyz","*.beaverslab.xyz"];
